...
function useLoadingStore(): BdtecSceneLoadingSnapshot {
    ...
    if (!storeRef) {
        throw new Error('useBdtecSceneLoadingState must be used within BdtecSceneLoadingProvider');
    }
...
export function BdtecSceneLoadingProvider({ children }: { children: React.ReactNode }) {
...
export function useBdtecSceneLoadingActions(): BdtecSceneLoadingActions {
    ...
    if (!ctx) {
        throw new Error('useBdtecSceneLoadingActions must be used within BdtecSceneLoadingProvider');
    }
    return ctx;
}
