...
export default function Overlay1() {
    ...
    return (
        <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', pointerEvents: 'none', zIndex: 10 }}>
            {/* 상단 로고 및 텍스트 */}
            <div style={{ position: 'absolute', fontSize: '13px', fontFamily: 'Meslo', lineHeight: '1.6em', whiteSpace: 'pre', pointerEvents: 'auto', width: '100%' }}>
                <div style={{padding: 20}}>
                    <div>
                        <div style={{width: '100%', textAlign: 'right', paddingBottom : 15}}>
                            <span style={{border: '1px dashed white', padding: '7px 12px', borderRadius: 20, fontSize: 12, color: 'white'}}>MENU</span>
                        </div>
                        <img ref={logoRef} src="/model/bdtec/Logo.svg" width={'100%'} alt="" style={{ willChange: 'transform' }} />
            ...
            {/* 우측 하단 인디케이터 */}
            <div ref={indicatorRef} style={{position: 'absolute', bottom: 50, right: 50, fontSize: '13px', willChange: 'opacity, transform'}}>
                <ScrollIndicator/>
            </div>
        </div>
    );
